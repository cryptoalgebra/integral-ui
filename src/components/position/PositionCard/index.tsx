...
const PositionCard = ({ pool, selectedPosition, farming, closedFarmings, poolStatus }: PositionCardProps) => {
    ...
    return (
        <div className="flex flex-col gap-6 bg-card border border-card-border rounded-2xl p-4 animate-fade-in w-full">
            <div className="relative flex w-full justify-start text-left">
                <div className="flex flex-col gap-4 w-full">
                    <h2 className="scroll-m-20 text-2xl font-bold tracking-tight bg-card-hover -mx-4 px-4 -mt-4 py-4 rounded-t-2xl border-b border-card-border lg:text-2xl">{`Position #${selectedPosition?.id}`}</h2>
