...
import { POOL_MAX_APR_API, fetcher, POOL_AVG_APR_API, ETERNAL_FARMINGS_API } from "@/constants/api";
import { farmingClient } from "@/graphql/clients";
import { usePoolsListQuery, useActiveFarmingsQuery } from "@/graphql/generated/graphql";
