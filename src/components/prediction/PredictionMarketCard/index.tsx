...
const PredictionMarketCard = ({ market, now, from = 'prediction' }: IPredictionMarketCard) => {
        ...
        >
            <div className="flex items-center gap-4 mb-4">
                ...
                <div className="w-9 h-9 relative">
                    ...
                    { !isOneHourMarket && <div className={cn("flex items-center justify-center absolute w-5 h-5 border rounded-full -right-2 -bottom-1", isGreater ? "bg-green-800 border-green-400" : "bg-red-800 border-red-400")}>
                        {isGreater ? (
            ...
            { isOpen ? <div className="flex gap-3 my-4 font-semibold mt-auto">
