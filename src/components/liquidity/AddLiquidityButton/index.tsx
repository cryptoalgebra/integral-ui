...
export const AddLiquidityButton = ({ baseCurrency, quoteCurrency, mintInfo }: AddLiquidityButtonProps) => {
  ...
  if (isReady && (approvalStateA === ApprovalState.NOT_APPROVED || approvalStateA === ApprovalState.PENDING || approvalStateB === ApprovalState.NOT_APPROVED || approvalStateB === ApprovalState.PENDING)) return <div className="flex w-full gap-2">
