...
import { Currency, CurrencyAmount, Percent, Position, computePoolAddressZkSync, unwrappedToken } from "@cryptoalgebra/integral-sdk";
...
export function useDerivedBurnInfo(
    ...
    const poolId = currency0 && currency1 && computePoolAddressZkSync({
