...
import { ADDRESS_ZERO, Currency, CurrencyAmount, Percent, TickMath, Trade, TradeType, computeCustomPoolAddress } from "@cryptoalgebra/scribe-sdk"
...
export function useDerivedSwapInfo(): {
    ...
    const poolAddress = isWrap ? undefined : currencies[SwapField.INPUT] && currencies[SwapField.OUTPUT] && computeCustomPoolAddress({
