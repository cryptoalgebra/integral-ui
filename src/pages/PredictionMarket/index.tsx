                ...
                <div className="flex flex-col gap-2 col-span-1 w-full">
                    <div className="py-2 border border-card-border rounded-lg">
                        <div className="flex font-semibold px-2">
                            <button
                                className={cn(
                                    "border-b-2 pb-2 px-2 transition",
                                    action === "buy" ? "border-primary" : "border-transparent hover:border-white/20",
                                )}
                            ...
                            <button
                                className={cn(
                                    "border-b-2 pb-2 px-2 transition",
                                    action === "sell" ? "border-primary" : "border-transparent hover:border-white/20",
                                )}
                    ...
                    {market && (
                        <div className="flex flex-col gap-2 text-sm text-white/60">
                            ...
                            <div className="text-left">
                                {`Source of the price is the ${pool?.token0.symbol === "WETH" ? "ETH" : pool?.token0.symbol} / ${
                                    pool?.token1.symbol
                                } pool.`}
                            </div>
                        </div>
                ...
                <div className="flex flex-col gap-4 col-span-2 md:max-h-[514px]">
                    ...
                    {chartType === "price" ? (
                        <Chart
                            ...
                            prediction={market ? (isLower ? { lower: +formattedCondition } : { greater: +formattedCondition }) : undefined}
                        />
                    ) : (
                        <PredictionChart
                            pool={pool}
