...
import { PredictionTrade } from "../../types";
...
export function PredictionTradesTable({ trades }: IPredictionTradesTable) {
            ...
            <div className="divide-y divide-gray-800">
              ...
              >
                ...
                <span>{mark}</span>
                            ...
                            <div>{formatNumber(trade.cost).toFixed(2)} USDC</div>

                            <div>{formatNumber(trade.shares).toFixed(2)} USDC</div>

                            <div className="text-gray-400">{formatDate(new Date(+trade.timestamp * 1000), new Date())}</div>
