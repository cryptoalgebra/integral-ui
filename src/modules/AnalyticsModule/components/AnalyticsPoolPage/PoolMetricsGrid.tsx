import { POOL_CHART_TYPE, PoolChartTypeType } from "@/types/swap-chart";
import { cn, formatAmount, formatPercent } from "@/utils";
import { PoolAnalyticsStatistics } from "./types";
...
export function PoolMetricsGrid({ activeChartType, apr, onSelectChartType, statistics }: PoolMetricsGridProps) {
    ...
    return (
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <MetricCard label="APR" value={apr === undefined ? "-" : `${formatAmount(apr, 2)}%`} />
        </div>
    );
}
