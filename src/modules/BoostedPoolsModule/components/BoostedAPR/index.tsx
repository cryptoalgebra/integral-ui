        ...
        <HoverCard openDelay={100} closeDelay={100}>
            <HoverCardTrigger asChild>
                <div className="flex items-center gap-1.5 cursor-pointer group">
                    <div className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-500 text-purple-500 text-xs font-semibold transition-all duration-200 group-hover:from-purple-500/30 group-hover:to-blue-500/30 group-hover:border-purple-500/60">
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        {token0Apr ? (
                            <div className="flex justify-between items-center">
                                ...
                                <span className="font-medium text-purple-400">+{formatAmount(token0Apr, 2)}%</span>
                            </div>
                        ) : null}
                        ...
                        {token1Apr ? (
                            <div className="flex justify-between items-center">
                                ...
                                <span className="font-medium text-purple-400">+{formatAmount(token1Apr, 2)}%</span>
                            </div>
                        ) : null}
