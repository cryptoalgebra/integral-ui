export const algebraCustomPluginFactoryABI = [
    {
        inputs: [
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: "address", name: "newFarmingAddress", type: "address" }],
        name: "FarmingAddress",
        type: "event",
    },
    {
    ...
    },
    {
        ...
        name: "pluginByPool",
        outputs: [{ internalType: "address", name: "pluginAddress", type: "address" }],
        stateMutability: "view",
        type: "function",
    },
    {
    ...
    {
        inputs: [{ internalType: "address", name: "newFarmingAddress", type: "address" }],
