...
export const LIMIT_ORDERS_GRAPH_URL = {
    [ChainId.Hemi]: "https://api.studio.thegraph.com/query/50593/base-testnet-limits/v0.0.6",
};

export const PREDICTION_GRAPH_URL = {
    [ChainId.Hemi]: "https://api.studio.thegraph.com/query/50593/prediction-market/v2.0.9",
};

// Boosted tokens APR
export const BLOCKS_GRAPH_URL = {
    [ChainId.Hemi]: "https://api.goldsky.com/api/public/project_cl8ylkiw00krx0hvza0qw17vn/subgraphs/blocks/base-sepolia/gn",
};
